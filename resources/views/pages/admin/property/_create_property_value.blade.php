<form id="property_value_form">
    ...
    <div class="row form-group">
        <div class="col-sm-4">
            <label for="property_slug">{{ __('Properties') }}</label>
        ...
        <div class="mt-1 w-100">
            <button class="mt-3 mb-3 btn float-right custom_button_color btn-warning btn-lg font-weight-medium add_property_value_btn" type="submit">
