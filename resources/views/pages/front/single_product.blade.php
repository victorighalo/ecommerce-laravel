    ...
    <div id="content">
        ...
        <div id="modal-center" class="uk-flex-top product-to-cart" uk-modal>
            <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
                ...
                <h4 class="text-center"><span class="text-bold">{{$product->title()}}</span> <span
                        class="cart-msg"></span></h4>
            ...
            <div class="container">
                                ...
                                <ul class="slides">
                                    @if($product->photos)
                                        @foreach($product->photos as $image)
                                            <li><img class="img-responsive" src="{{asset($image->ImageUrl)}}"
                                                     alt="{{$product->title()}}"
                                ...
                                <ul class="row margin-top-30">
                                    <li class="col-sm-12">
                                        ...
                                        <div class="quinty">
                                            ...
                                            <input type="number" id="quantity" name="item_qty"
                ...
                <!-- Nav tabs -->
                    <ul class="nav nav-pills" role="tablist">
                        <li class="nav-item"><a class="active nav-link" href="#descr" role="tab" data-toggle="pill">DESCRIPTION</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="#review" role="tab" data-toggle="pill">REVIEW
                                ({{$product->commentCount()}})</a></li>
                    </ul>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="review">
                            @if(isset($product->comments))
                                @if(count($product->comments))
                                    <h6>{{$product->commentCount()}} REVIEWS FOR SHIP
                                        YOUR {{strtoupper($product->title())}}</h6>
                                @else
                                ...
                                <!-- REVIEW PEOPLE 1 -->
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <p>{{$comment->body}}</p>
                                            <h6> {{strtoupper($comment->creator->firstname)}} <span
                                ...
                                <ul class="row">
                                    <li class="col-sm-6">
                                        <label> *NAME
                                            ...
                                            @else
                                                <input type="text" value="" placeholder="{{Auth::user()->firstname}}"
                                                       disabled>
                                            @endif
                                        </label>
                                    </li>
