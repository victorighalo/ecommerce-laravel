        ...
        <section class="history-block padding-top-100 padding-bottom-100">
            <div class="container">
                <div class="d-flex justify-content-center flex-column align-items-center">
                    <div class="col-sm-8" style="height: 100px; background: #54b342;">
                        <h4 style="color: #fff;margin-top: 35px;">Transaction Pending Cash on Delivery</h4>
                        <p style="color: #fff;text-align: center">Your items will be delivered to you. Ensure to make payment on delivery</p>
                    </div>
